...
@SpringBootTest(properties = {
        ...
        "gateway.services.geolocation.base-url=http://geolocation-service:8080",
...
class GatewayRoutesConfigTests {
    ...
    void shouldRegisterExpectedGatewayRoutes() {
        ...
        assertThat(routes.get("geolocalizacion-api").getUri().toString()).isEqualTo("http://geolocation-service:8080");
